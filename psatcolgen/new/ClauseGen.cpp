...
void ClauseGen::restartSolver(Solver *s){
	solver = s;
}

//adds a literal to a clause
void addLit(vec<Lit>& lits, long longlit, Solver* solver){
    int var, lit;
...
//This function restarts values from the ClauseGen
...
//This function adds Gamma clauses to the SAT instance
void ClauseGen::addGamma(){
    int i,nClause, nVar;
    long lit;
    FILE * gamma;
    vec<Lit> lits;
...
//adds the clauses corresponding to the "exclusive OR" operation between atoms 'a' and 'b'
void ClauseGen::xor2( long a, long b){
    vec<Lit> lits;

    countClause+=2;
    
    addLit(lits, a, solver);
    addLit(lits, b, solver);
...
//adds the clauses corresponding to the equivalence between 'r' and the result of the "exclusive OR" operation between literals 'a' and 'b'
void ClauseGen::eq_xor2( long r, long a, long b){
    vec<Lit> lits;
    
    countClause+=4;
    
    addLit(lits, -r, solver);
    addLit(lits, a, solver);
    addLit(lits, b, solver);
...
//adds the clauses corresponding to the "exclusive OR" operation among 'n' literals
...
//adds the clauses corresponding to the "exclusive OR" operation among 'n' literals, given as an array
void ClauseGen::orNlist( int n, long *list){
    ...
    countClause+=1;
    for(i=0;i<n;i++){
        addLit(lits, list[i], solver);
    }
    solver->addClause_(lits);
    lits.clear();
}

//adds the clauses corresponding to the "OR" operation between 2 literals
void ClauseGen::or2( long a,long b){orN(2, a, b);}

//adds the clauses corresponding to the equivalence between 'r' and the result of the "OR" operation among 'n' literals
...
//adds the clauses corresponding to the equivalence between 'r' and the result of the "OR" operation between literals 'a' and 'b'
void ClauseGen::eq_or2( long r, long a, long b){eq_orN(2, r, a, b);}

//adds the clauses corresponding to the "AND" operation between 'n' literals
...
//adds the clauses corresponding to the "AND" operation between literals 'a' and 'b
void ClauseGen::and2( long a, long b){andN( 2, a, b);}

//adds the clauses corresponding to the equivalence between 'r' and the result of the "AND" operation among 'n' literals
...
//adds the clauses corresponding to the equivalence between 'r' and the result of the "AND" operation between literals 'a' and 'b'
void ClauseGen::eq_and2( long r, long a, long b){eq_andN(2, r, a, b);}

//adds the clauses corresponding to the equivalence between 'r' and the result of the "equivalence" operation between literals 'a' and 'b'
...
//adds the clauses corresponding to the equivalence between the array of literals 'sum' and the result of the bitwise sum operation between two array of literals, p1 an p2 - all arrays with 'bits' literals representing integer numbers in the binary system.
...
//adds the clauses corresponding to the  "greater than or equal to" operation between two array of literals, p1 an p2 - all arrays with 'bits' literals representing integer numbers in the binary system.
